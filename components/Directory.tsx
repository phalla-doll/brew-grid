  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-white selection:text-black pb-24">
      <div className="max-w-7xl mx-auto px-6 py-24 sm:py-32">
        {/* Header Section */}
        <header className="mb-24 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden md:overflow-visible">
          <motion.div
          ...
          <motion.div
            ...
            className="absolute -right-12 -top-12 md:relative md:right-auto md:top-auto pointer-events-none select-none z-0"
          >
            <motion.div
              animate={{ 
                y: [0, -20, 0],
            ...
            >
              <svg className="w-64 h-64 lg:w-96 lg:h-96 drop-shadow-[0_0_50px_rgba(250,175,65,0.15)] opacity-15 md:opacity-30 text-white" viewBox="0 0 164 256" preserveAspectRatio="xMidYMid">
