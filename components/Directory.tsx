      ...
      <div className="max-w-7xl mx-auto px-6 py-24 sm:py-32">
        ...
        <header className="mb-24 flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden md:overflow-visible">
          ...
          <motion.div
            ...
            className="absolute -right-12 -top-12 md:relative md:right-auto md:top-auto opacity-10 md:opacity-100 pointer-events-none select-none z-0"
          >
            <motion.div
              animate={{ 
                y: [0, -15, 0],
            ...
            >
              <svg className="w-64 h-64 lg:w-80 lg:h-80 drop-shadow-[0_0_40px_rgba(250,175,65,0.2)]" viewBox="0 0 164 256" preserveAspectRatio="xMidYMid">
